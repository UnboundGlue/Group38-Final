...
\begin{figure}[t]
  ...
  \caption{LIME token contributions for a correctly attributed test tweet (author 23, \(p\!\approx\!1.0\)). Positive (blue) weights push towards the predicted author; the dominant cues are capitalised function words, evidence of a title-casing writing style.}
  \label{fig:lime}
\end{figure}
